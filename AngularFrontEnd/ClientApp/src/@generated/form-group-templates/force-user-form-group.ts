...
export class ForceUserFormGroup {

  static createFromDto(dto: ForceUser): FormGroup {
    const formGroup = ForceUserFormGroup.create();
  ...
  static createFormFromDto(dto: ForceUser): FormGroup {
